    ...
    <div className="mt-2 rounded-xl border border-white/5 bg-white/[0.02] overflow-hidden">
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex gap-2 pt-1">
          <button className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-white bg-gradient-to-r from-blue-600 to-cyan-600 rounded-lg hover:from-blue-500 hover:to-cyan-500 transition-all">
            <Send className="w-3 h-3" />
            Send
          </button>
          <button className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-neutral-300 border border-white/10 rounded-lg hover:bg-white/5 transition-all">
